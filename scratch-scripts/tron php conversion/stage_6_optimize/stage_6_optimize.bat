...
:: Version:       1.0.5 * Update date/time logging functions to use new log_with_date.bat. Thanks to /u/DudeManFoo
...
:: PREP AND CHECKS ::
:::::::::::::::::::::
set STAGE_6_SCRIPT_VERSION=1.0.5
set STAGE_6_SCRIPT_DATE=2017-03-02
