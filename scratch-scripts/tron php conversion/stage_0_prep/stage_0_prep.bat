...
:: Version:       1.1.7 * Update date/time logging functions to use new log_with_date.bat. Thanks to /u/DudeManFoo
...
:: PREP AND CHECKS ::
:::::::::::::::::::::
set STAGE_0_SCRIPT_VERSION=1.1.7
set STAGE_0_SCRIPT_DATE=2017-03-02
